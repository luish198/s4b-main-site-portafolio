            ...
            <div className="row">
                ...
                <div className="col-lg-6 col-xm-12" mb-5>
                    ...
                    <p>
                        ...
                        Our Modules are responsive in a variety of devices desktops and smartphones using different frameworks such as Bootstrap, Material U.I, r-suit etc...

                        The module creation implies a thorough understanding of our client current process flow as well as any new ideas to implement, changes or updates in order to gain a competitive advantage against competitors via process optimization and web technologies implementation.

                        We want our clients to be able to eliminate or minimize bottlenecks and unnecessary overhear work allow them to focus on what they do best !
